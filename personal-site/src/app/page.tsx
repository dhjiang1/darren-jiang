...
<Swiper
        ...
        <SwiperSlide>
              <div className="card">
                ...
                <div className="card-content">
                  ...
                  <p className="card-text">Collaborated with Engineering in the development of a VBA testing tool used in the globally distributed data storage architecture migration.</p>
                  <button className="card-btn"><a href="https://drive.google.com/file/d/1-MvnU9SmC7aIMsoZW4Svk4UNT25bzSbk/view?usp=sharing" target="_blank">View More</a></button>
                </div>
      ...
      <section className={styles.contact} id="contact">
        ...
        <div className={styles.message}>
          <div className={styles.bye_msg}>I love meeting new individuals and discussing all things tech! Currently seeking exciting opportunities to deliver impactful features to users - shoot me a message!</div>
        </div>
